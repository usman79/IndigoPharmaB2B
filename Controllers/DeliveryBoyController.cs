...
namespace IndigoAdmin.Controllers
{
    public class DeliveryBoyController : Controller
    {
        ...
        public DeliveryBoyController(IUserAccountService UserAccountService, IOrderService OrderService)
        {
        ...
        [HttpGet]
        public JsonResult GetAllDeliveryBoy()
        {
            var listCompanies = _UserAccountService.GetAllByRole(5);
