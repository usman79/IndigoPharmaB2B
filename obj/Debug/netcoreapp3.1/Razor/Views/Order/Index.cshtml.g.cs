#pragma checksum "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Order\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "07c5564c3966b7c5d11cacefa5a0e0114dca48b5bdbd0191eaec78478626981e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"07c5564c3966b7c5d11cacefa5a0e0114dca48b5bdbd0191eaec78478626981e", @"/Views/Order/Index.cshtml")]
    ...
    #nullable disable
    {
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_0 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("src", new global::Microsoft.AspNetCore.Html.HtmlString("~/Assets/js/price-helper.js"), global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        {
#nullable restore
#line 1 "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Order\Index.cshtml"
...
#nullable disable
    ...
    <style>
        ...
        .invo");
                WriteLiteral(@"ice-POS .mb-4, .invoice-POS .my-4 {
        ...
        .invoice-POS .bgc-default-tp1 {
            backgro");
                WriteLiteral(@"und-color: rgba(121,169,197,.92) !important;
        }
    ...
    <div class=""row"">
        ...
        <div class=""col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"">
            <div class=""card table-card"">
                ...
                <div class=""card-body"">
                    <table id=""d");
            WriteLiteral(@"tOrders"" class=""table table-striped table-bordered dt-responsive nowrap"" style="" width: 100%;table-layout: fixed !important;word-wrap: break-word;"">
                        <thead>
                            <tr>
                                <th style=""width:5%""><div class=""form-check""> <input name=""select_all"" class=""form-check-input"" type=""checkbox""");
            BeginWriteAttribute("value", " value=\"", 5817, "\"", 5825, 0);
            EndWriteAttribute();
...
");
    ...
    <div class=""modal fade"" id=""modalPayment"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalLongTitle"" aria-hidden=""true"">
        <div class=""modal-dialog modal-lg"" role=""document"">
           ...
           ");
                WriteLiteral(@"                 <label class=""col-form-label"">Amount</label>
    ...
    <div class=""modal fade"" id=""modalReceipt"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalLongTitle"" aria-hidden=""true"">
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
             ...
             ");
                WriteLiteral(@"       <button type=""button"" class=""close"" data-bs-dismiss=""modal"" aria-label=""Close"">
                        <span aria-hidden=""true"">&times;</span>
                    </button>
                </div>
                <div class=""modal-body"">
           ...
           ");
                WriteLiteral(@"                                     <th width=""80%"">Product Name</th>
                ...
                WriteLiteral(@"                                       </tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class=""net"">
                                            ...
                                            <td colspan=""2""><h4 class=");
                WriteLiteral(@"""total""></h4></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
...
");
            ...
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "07c5564c3966b7c5d11cacefa5a0e0114dca48b5bdbd0191eaec78478626981e23610", async() => {
                }
                );
        ...
        function BindDataTable(data) {
            ...
            dtOrders = $('#dtOrders').DataTable({
                ...
                rowCallback: function (row, data) {
                    if (data.Status == 4) {
                        $(ro");
                WriteLiteral(@"w).addClass('complete');
                    }
                },
                columns: [
                    {
    ...
    ");
                WriteLiteral(@"                {
                        ...
                        render: function (data, type, row, meta) {
                         ...
                         ");
                WriteLiteral(@"   else if (row.Status == 3) {
                            ...
                            return '<div class=""dropdown""> ' + label + ' <ul class=""dropdown-menu"" aria-labelledby=""dropdownMenuButton1""> <li><a class=""dropdown-item ' + pendingDisabled + '""  href=""#"" onclick=""UpdateOrderStatus(this,1)""><label class=""mb-0 badge badge-dark w-100"">Pending</label></a></li> <li><a onclick=""UpdateOrderStatus(this,2)"" class=""dropdown-item"" href=""#""><label class=""mb-0 badge badge-primary w-100"">Processing</label></a></li> <li><a onclick=""UpdateOrderStatus(this,3)"" cl");
                WriteLiteral(@"ass=""dropdown-item ' + cancelDisabled+'"" href=""#""><label class=""mb-0 badge badge-danger w-100"">Canceled</label></a></li> <li><a onclick=""UpdateOrderStatus(this,4)"" class=""dropdown-item"" href=""#""><label class=""mb-0 badge badge-success w-100"">Complete</label></a></li> </ul> </div>';
                        }
                    },
                    {
                        ""searchable"": false,
                ...
                WriteLiteral(@": false,
                    ...
                    },
                    {
                        ...
                        ""orderable"": false,
                        render: function (data, type, row, meta) {
                            var html = '<button onclick=""ViewDetails(this)"" class=""btn btn-primary mt-2 mr-2 icon-sm"" t");
                WriteLiteral(@"itle="""" data-original-title=""Pending""><i class=""fas fa-eye""></i></button><button onclick=""PrintReciept(this)"" class=""btn btn-secondary mt-2 mr-2 icon-sm"" title="""" data-original-title=""Pending""><i class=""fas fa-print""></i></button>';
                            return html;
                        }
                    },
                    {
        ...
        function BindDetailsDataTable(data) {
            if ");
                WriteLiteral(@"(dtOrderDetails != null)
   ...
   ");
        ...
        function putCoins(order) {
            if (order.TotalAmount >= 1000) {
                var coins=Math.floor(order.TotalAmo");
                WriteLiteral(@"unt / 1000) * 10;
                alert(coins+""  added"");
            }
        }
                ...
                success: function (data) {
                    ...
                    if (data != null && data.length > 0) {
                        ...
                        data.forEach((element) => {
                            ...
                            var html = '<tr> <td class=""ps");
                WriteLiteral(@"-2"">' + index + '</td> <td>' + element.ProductName + '</td> <td>' + element.Quantity + '</td></tr>';
        ...
        async function PrintSingle() {
            ...
            const blob = await window.ht");
                WriteLiteral(@"ml2pdf().set(opt).from(element).outputPdf('blob', filename);
