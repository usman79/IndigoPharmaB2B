#pragma checksum "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Supplier\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "24356b26ef9e004e8bfb8930b000d76e98576c013b5ea7250ea0d60d49f8b1e5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"24356b26ef9e004e8bfb8930b000d76e98576c013b5ea7250ea0d60d49f8b1e5", @"/Views/Supplier/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n\r\n");
#nullable restore
#line 3 "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Supplier\Index.cshtml"
    ...
    <div class=""row"">
        <div class=""colxl-12 col-lg-12 col-md-12 col-sm-12 col-12"">
            ...
            WriteLiteral(@"0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17
                        ...
                        <li>
                            <div class=""add-group"">
                                <a class=""ad-btn"" onclick=""OpenNewModel()"">New Vendor</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class=""row"">
        ...
        <div class=""col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"">
            <div class=""card table-card"">
                ...
                <div class=""card-body"">
                    <table id=""dtUsers"" class=""table table-strip");
            WriteLiteral(@"ed table-bordered dt-responsive nowrap"" style=""width:100%"">
                        <thead>
                            <tr>
        ...
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "24356b26ef9e004e8bfb8930b000d76e98576c013b5ea7250ea0d60d49f8b1e57500", async() => {
                    WriteLiteral(@"
                        <div class=""row"">
...
");
    ...
    <script>
        ...
        function BindDataTable(data) {
            ...
            dtUsers = $('#dtUsers').DataTable({
                ...
                WriteLiteral(@"t"",
                        ""orderable"": false,
                        render: function (data, type, row, meta) {
                            return '<a href=""/Inventory/SuplierPurchase?Id=' + row.UserId +'"" target=""_blank"" class=""mb-0 badge badge-success"">View</a>'
                        }
                    },
                    {
                        data: null,
        ...
        function EditItem(element) {
            var data = dtUsers.row($(element).parents('tr')).da");
                WriteLiteral(@"ta();
        ...
        function DeleteItem(id) {
            var host = window.location;
            $.ajax({
                url: host.protocol + ""//"" + host.host + '/Supplier/Delete?id=' + id,
                type: ""DELETE"",
                contentType: ""application/json; charset=utf-8"",
        ...
        function SaveItem() {
            if (CheckRequired($('#UserForm'))) {
                ...
                $.ajax({
             ");
                WriteLiteral(@"       url: '/Supplier/Save',
                    type: ""POST"",
                    contentType: false,
                    processData: false,
                    data: formData,
