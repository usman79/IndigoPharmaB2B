#pragma checksum "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\DeliveryBoy\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "cd59270147dac7859f850d66ae5cccb4080542871986dd90c98d57b250805f11"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"cd59270147dac7859f850d66ae5cccb4080542871986dd90c98d57b250805f11", @"/Views/DeliveryBoy/Index.cshtml")]
    ...
    #nullable restore
    public class Views_DeliveryBoy_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\DeliveryBoy\Index.cshtml"
                            ...
                            <div class=""ad-user-btn"">
                                ...
                                <svg version=""1.1"" xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 56.966 56.966"">
                                    <path d=""M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23
												...
												c0.779,0,");
            WriteLiteral(@"1.518-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17
    ...
    <div class=""row"">
        ...
        <div class=""col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"">
            <div class=""card table-card"">
                ...
                <div class=""card-body"">
                    <table id=""dtDeliveryBoys"" cl");
            WriteLiteral(@"ass=""table table-striped table-bordered dt-responsive nowrap"" style=""width:100%"">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
");
        ...
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cd59270147dac7859f850d66ae5cccb4080542871986dd90c98d57b250805f117888", async() => {
                    WriteLiteral(@"
                        <div class=""row"">
    ...
    <div class=""modal fade"" id=""orderModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalLongTitle"" aria-hidden=""true"">
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                ...
                WriteLiteral("UserId\" />\r\n                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cd59270147dac7859f850d66ae5cccb4080542871986dd90c98d57b250805f1113517", async() => {
                    WriteLiteral(@"
                        <div class=""col-4"">
    ...
    <div class=""modal fade"" id=""returnModal"" tabindex=""-1"" ");
                WriteLiteral(@"role=""dialog"" aria-labelledby=""exampleModalLongTitle"" aria-hidden=""true"">
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                <div class=""modal-header"">
                ...
                <div class=""modal-footer"">
                    <button type=""button"" class=""btn btn-primary"" id=""upda");
                WriteLiteral(@"teDetailBtn"" onclick=""UpdateOrderDetails()"">Update</button>
                    <button type=""button"" class=""btn btn-secondary"" data-bs-dismiss=""modal"">Close</button>
                </div>
            </div>
        </div>
    ...
    <div class=""modal fade"" id=""modalOrderProcess"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalLongTitle"" aria-hidden=""true"">
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
 ");
                WriteLiteral(@"                   <ul class=""nav nav-tabs"" id=""orderWizardTabs"" role=""tablist"">
                        <li class=""nav-item"">
                    ...
                    <div class=""tab-content ad-content2"">
                        <div class=""tab-pane fade active show"" id=""tabReturn"" role=""tabpanel"">
                            ...
                            <table id=""dtOrderDetails"" class=""table table-striped table-border");
                WriteLiteral(@"ed dt-responsive nowrap"" style="" width: 100%;table-layout: fixed !important;word-wrap: break-word;"">
                                <thead>
                                    <tr>
                            ...
                            <div id=""CheckDetails"">
                                <div class=""col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"">
                                    <div class=""form-group"">
                                        ...
                                        <input required=""required"" id=""ChequeNumb");
                WriteLiteral(@"er"" class=""form-control required"" type=""text"" placeholder=""Cheque Number"">
                                    </div>
                                </div>
                                <div class=""col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"">
                                    <div class=""form-group"">
                            ...
                            <div id=""CashDetails"" class=""hide"">
                                <div class=""col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"">
                                    <div class=""form-group"">
                                        ...
                                        <input required=""required"" id=""PaymentAmount"" class=""form-control required"" type=""text"" placehol");
                WriteLiteral(@"der=""Amount"">
                                    </div>
                                </div>
                                <div class=""col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"">
                                    <div class=""form-group"">
...
");
    ...
    <script>
        ...
        function BindDataTable(data) {
            ...
            dtDeliveryBoys = $(");
                WriteLiteral(@"'#dtDeliveryBoys').DataTable({
                ...
                WriteLiteral(@" ""orderable"": false,
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            return '<div class=""dropdown""> ' + label + ' <ul class=""dropdown-menu""> <li><a class=""dropdown-item"" href=""#"" onclick=""UpdateUserStatus(this,true)""><label class=""mb-0 badge badge-success w-100"">Active</label></a></li> <li><a class=""dropdown-item"" href=""#"" onclick=""UpdateUserStatus(this,false)""><label class=""mb-0 badge badge-danger w-100"">InActiv");
                WriteLiteral(@"e</label></a></li>  </ul> </div>';
                        }
                    },
                    ...
                    },
                    {
                        ...
                        ""orderable"": false,
                        render: f");
                WriteLiteral(@"unction (data, type, row, meta) {
        ...
        function SaveItem() {
            if (CheckRequired($('#userForm'))) {
                ...
                formData.append('U");
                WriteLiteral(@"serId', UserInfo.UserId);
  ...
  ");
   ...
   ");
                WriteLiteral(@"     function LoadOrders(Id, StartDate, EndDate, Today) {
            $.ajax({
                type: ""GET"",
                contentType: ""application/json; charset=utf-8"",
        ...
        function BindDatewiseOrder(data) {
            ...
            dtOrdersDate = $('#dtOrdersDate').DataTable({
                ...
                rowCallback: function (row, data) {
                    if (data.Status == 4) {
");
                WriteLiteral(@"                        $(row).addClass('complete');
                    }
                },
                columns: [
                    {
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            var label = '';
                            if (row.Status == 1) {
                                label = '<label class=""mb-0 badge badge-dark toltiped"" data-bs");
                WriteLiteral(@"-toggle=""dropdown"">Pending</label>';
                            }
               ...
               ");
                WriteLiteral(@"         render: function (data, type, row, meta) {
                    ...
                    },
                    {
                        data: null,
                        ""searchable"": false,
                        class: ""no-sort text-cent");
                WriteLiteral(@"er"",
                        ""orderable"": false,
                        render: function (data, type, row, meta) {
                            //var html = '<div class=""relative""><a class=""action-btn"" href=""javascript:void(0);""> <svg class=""default-size "" viewBox=""0 0 341.333 341.333 ""> <g> <g> <g> <path d=""M170.667,85.333c23.573,0,42.667-19.093,42.667-42.667C213.333,19.093,194.24,0,170.667,0S128,19.093,128,42.667 C128,66.24,147.093,85.333,170.667,85.333z ""></path> <path d=""M170.667,128C147.093,128,128,147.093,128,170.667s19.093,42.667,42.667,42.667s42.667-19.093,42.667-42.667 S194.24,128,170.667,128z ""></path> <path d=""M170.667,256C147.093,256,128,275.093,128,298.667c0,23.573,19.093,42.667,42.667,42.667s42.667-19.093,42.667-42.667 C213.333,275.093,194.24,256,170.667,256z ""></path> </g> </g> </g> </svg> </a> <div class=""action-option""> <ul><li> <a onclick=""AddPaymentMenuClick(this)"" href=""javascript:void(0);""><i class=""far fa-edit mr-2""></i>Payment</a> </li><li> <a onclick=""AddExpenseMenuClick(this)"" href");
                WriteLiteral(@"=""javascript:void(0);""><i class=""far fa-edit mr-2""></i>Debit Expense</a> </li> <li> <a onclick=""ViewDetails(this)"" href=""javascript:void(0);""><i class=""far fa-edit mr-2""></i>Return</a> </li> </ul> </div></div>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (editingOrder.PaymentType == 1) {
                        $('#C");
                WriteLiteral(@"heckDetails').addClass('hide');
                    ...
                    $('#PaymentAmount').val(0);
            ");
                WriteLiteral(@"        $('#ExpenseAmount').val(0);
                },
                error: function (result) {
                }
            });
        ...
        function PerformPrevious() {
            ...
            if (selectedTab == ""paymentTab"") {
                $(");
                WriteLiteral(@"""ul#orderWizardTabs #returnTab"").tab('show');
        ...
        function PerformNext() {
            ...
            if (selectedTab == ""returnTab"") {
                ...
                var objProcessedOrder = {
                    ...
                    'OrderId': editingOrder.OrderId,
       ");
                WriteLiteral(@"             'PaymentType': editingOrder.PaymentType,
