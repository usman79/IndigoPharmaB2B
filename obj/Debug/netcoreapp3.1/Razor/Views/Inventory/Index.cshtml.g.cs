#pragma checksum "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Inventory\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "6d67dd1eb53bfb82f6db3ca3a6e34139b7e23629bc72b1d93038636092b604d4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"6d67dd1eb53bfb82f6db3ca3a6e34139b7e23629bc72b1d93038636092b604d4", @"/Views/Inventory/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n\r\n");
#nullable restore
#line 3 "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Inventory\Index.cshtml"
                            ...
                            <div class=""ad-user-btn"">
                                ...
                                <svg version=""1.1"" xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 56.966 56.966"">
                                    <path d=""M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23
												...
												c0.779,0,1.51");
            WriteLiteral(@"8-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17
    ...
    <div class=""row"">
        ...
        <div class=""col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"">
            <div class=""card table-card"">
                ...
                <div class=""card-body"">
                    <table id=""dtBrands"" class=""table ta");
            WriteLiteral(@"ble-striped table-bordered dt-responsive nowrap"" style="" width: 100%;table-layout: fixed !important;word-wrap: break-word;"">
                        <thead>
                            <tr>
        ...
        <div class=""modal-dialog modal-lg"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6d67dd1eb53bfb82f6db3ca3a6e34139b7e23629bc72b1d93038636092b604d47819", async() => {
                    WriteLiteral(@"
                        <div class=""row"">
                    ...
                    WriteLiteral(@"         <div class=""form-group"">
                            ...
                            <div class=""col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"">
                                <div class=""form-group"">
                                    <label class=""col-form-label"">Additional Discount</labe");
                    WriteLiteral(@"l>
                            ...
                            <div class=""col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4"">
                                <div class=""form-group"">
                                    ...
                                    <input disabled=""");
                    WriteLiteral(@"disabled"" required=""required"" id=""TP"" class=""form-control required"" type=""number"" placeholder=""Price"">
                            ...
                            <div class=""col-md-12 text-center"">
                                <button id=""btnAddToGrid"" type=""button"" class=""btn btn-sm btn-primary"" onclick=""AddItemToGri");
                    WriteLiteral("d()\">Add Item</button>\r\n                            </div>\r\n                            <input type=\"hidden\" id=\"InventoryId\" />\r\n                            <input type=\"hidden\" id=\"ItemId\" />\r\n                        </div>\r\n                    ");
                }
                );
                    ...
                    <table id=""batchTable"" class=""dataTable"">
                        ...
                        <tbody id=""GridNewPurchase"">
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><button onclick=""OpenInventoryModal(this)"" type=""button"" class=""btn btn-info btn-add""><i class=""fas fa-pencil-alt""></i></button><button onclick=""O");
                WriteLiteral(@"penInventoryModal(this)"" type=""button"" class=""btn btn-danger btn-add""><i class=""fas fa-trash""></i></button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
");
            ...
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n    <script>\r\n        var dtBrands = null;\r\n        var EditObject = null;\r\n        var UserId = ");
#nullable restore
#line 191 "C:\Users\usman\Desktop\Indigo\IndigoAdmin\IndigoAdmin\Views\Inventory\Index.cshtml"
...
#nullable disable
  ...
  ");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (entry) {
                        $('#InventoryProductId').append(");
                WriteLiteral(@"'<option value=""' + entry.ProductId + '"">' + entry.Title + '</option>')
                    });
                ...
                error: function (result) {
                    $('#InventoryProductId').select2({
                        dropdownParent: $(""#addIn");
                WriteLiteral(@"ventoryModel"")
                    });
                }
            });
        }
        ...
        function OpenNewModel() {
            $('#InventoryId').val('');
           ");
                WriteLiteral(@" $('#InventoryProductId').val('');
            $('#InventoryQuantity').val('');
            $('#SupplierId').val('');
            $('#InventoryPrice').val('');
            $('#BatchNumber').val('');
        ...
        ");
                WriteLiteral(@"    $('#MRP').val(data.Price);
  ...
  ");
                WriteLiteral(@"                      Quantity : $('#InventoryQuantity').val(),
   ...
   ");
                WriteLiteral(@"             if (itemId != '') {
                    ...
                    for (var i = 0; i < NewItemList.length; i++) {
                        ...
                        $('#GridNewPurchase').append('<tr id=""row_' + i + '""> <td>' + InventoryInfo._prodName + '</td> <td>' + InventoryInfo.BatchNumber + '</td> <td>' + InventoryInfo.Quantit");
                WriteLiteral(@"y + '</td> <td>' + InventoryInfo.Price + '</td><td>' + InventoryInfo.PurchasePrice + '</td> <td><button onclick=""DeleteGridItem(this)"" type=""button"" class=""btn btn-danger btn-add""><i class=""fas fa-trash""></i></button></td> </tr>');//<button onclick=""EditGridItem(this)"" type=""button"" class=""btn btn-info btn-add""><i class=""fas fa-pencil-alt""></i></button>
                    }
                } else {
                    GridItemIndex++;
                    var InventoryInfo = {
                        ...
                        PurchasePrice: $('#PurchasePrice').val(),
                        _prodName: $('#Inventor");
                WriteLiteral(@"yProductId option:selected').text()
                    };
